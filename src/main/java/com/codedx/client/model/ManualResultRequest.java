...
import com.codedx.client.model.DescriptionFormat;
import com.codedx.client.model.PathType;
...
public class ManualResultRequest {
  ...
  public ManualResultRequest projectId(Integer projectId) {
  ...
  **/
  ...
  public ManualResultRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ManualResultRequest detectionMethod(Integer detectionMethod) {
  ...
  **/
  ...
  public void setDetectionMethod(Integer detectionMethod) {
    this.detectionMethod = detectionMethod;
  }

  public ManualResultRequest tool(String tool) {
    this.tool = tool;
    return this;
  }
  ...
  **/
  ...
  public ManualResultRequest descriptorSeverity(String descriptorSeverity) {
    this.descriptorSeverity = descriptorSeverity;
    return this;
  }

   /**
   * Get descriptorSeverity
   * @return descriptorSeverity
  **/
  @ApiModelProperty(value = "")
  ...
  public void setDescriptorSeverity(String descriptorSeverity) {
    this.descriptorSeverity = descriptorSeverity;
  }

  public ManualResultRequest descriptorCwe(Integer descriptorCwe) {
    this.descriptorCwe = descriptorCwe;
    return this;
  }

   /**
   * Get descriptorCwe
   * @return descriptorCwe
  **/
  @ApiModelProperty(value = "")
  ...
  public void setDescriptorCwe(Integer descriptorCwe) {
    this.descriptorCwe = descriptorCwe;
  }

  public ManualResultRequest descriptorDescription(String descriptorDescription) {
  ...
  **/
  ...
  public ManualResultRequest descriptorDescriptionFormat(DescriptionFormat descriptorDescriptionFormat) {
    this.descriptorDescriptionFormat = descriptorDescriptionFormat;
    return this;
  }

   /**
   * Get descriptorDescriptionFormat
   * @return descriptorDescriptionFormat
  **/
  @ApiModelProperty(value = "")
  ...
  public ManualResultRequest locationPath(String locationPath) {
  ...
  **/
  ...
  public ManualResultRequest locationPathType(PathType locationPathType) {
    this.locationPathType = locationPathType;
    return this;
  }

   /**
   * Get locationPathType
   * @return locationPathType
  **/
  @ApiModelProperty(value = "")
  ...
  public ManualResultRequest locationLine(Integer locationLine) {
  ...
  **/
  ...
  public ManualResultRequest cwe(Integer cwe) {
    this.cwe = cwe;
    return this;
  }
  ...
  **/
  ...
  public ManualResultRequest description(String description) {
  ...
  **/
  ...
  public ManualResultRequest severity(String severity) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ManualResultRequest manualResultRequest = (ManualResultRequest) o;
    return Objects.equals(this.projectId, manualResultRequest.projectId) &&
        Objects.equals(this.name, manualResultRequest.name) &&
        Objects.equals(this.detectionMethod, manualResultRequest.detectionMethod) &&
        Objects.equals(this.tool, manualResultRequest.tool) &&
        Objects.equals(this.descriptorSeverity, manualResultRequest.descriptorSeverity) &&
        Objects.equals(this.descriptorCwe, manualResultRequest.descriptorCwe) &&
        Objects.equals(this.descriptorDescription, manualResultRequest.descriptorDescription) &&
        Objects.equals(this.descriptorDescriptionFormat, manualResultRequest.descriptorDescriptionFormat) &&
        Objects.equals(this.locationPath, manualResultRequest.locationPath) &&
        Objects.equals(this.locationPathType, manualResultRequest.locationPathType) &&
        Objects.equals(this.locationLine, manualResultRequest.locationLine) &&
        Objects.equals(this.cwe, manualResultRequest.cwe) &&
        Objects.equals(this.description, manualResultRequest.description) &&
        Objects.equals(this.descriptionFormat, manualResultRequest.descriptionFormat) &&
        Objects.equals(this.severity, manualResultRequest.severity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectId, name, detectionMethod, tool, descriptorSeverity, descriptorCwe, descriptorDescription, descriptorDescriptionFormat, locationPath, locationPathType, locationLine, cwe, description, descriptionFormat, severity);
  }
  ...
  public String toString() {
    ...
    sb.append("    descriptorSeverity: ").append(toIndentedString(descriptorSeverity)).append("\n");
    sb.append("    descriptorCwe: ").append(toIndentedString(descriptorCwe)).append("\n");
    sb.append("    descriptorDescription: ").append(toIndentedString(descriptorDescription)).append("\n");
    sb.append("    descriptorDescriptionFormat: ").append(toIndentedString(descriptorDescriptionFormat)).append("\n");
    sb.append("    locationPath: ").append(toIndentedString(locationPath)).append("\n");
    sb.append("    locationPathType: ").append(toIndentedString(locationPathType)).append("\n");
    sb.append("    locationLine: ").append(toIndentedString(locationLine)).append("\n");
