...
/**
 * Gets or Sets SortDescriptor
 */
@JsonAdapter(SortDescriptor.Adapter.class)
public enum SortDescriptor {
  ...
  public static SortDescriptor fromValue(String text) {
    for (SortDescriptor b : SortDescriptor.values()) {
  ...
  public static class Adapter extends TypeAdapter<SortDescriptor> {
    @Override
    public void write(final JsonWriter jsonWriter, final SortDescriptor enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SortDescriptor read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SortDescriptor.fromValue(String.valueOf(value));
    }
  }
}
