...
import com.codedx.client.model.AnalysisRecord;
...
public class ProjectQueryResponse {
  ...
  private List<Integer> hierarchyIds = null;

  @SerializedName("latestCompleteAnalysis")
  private AnalysisRecord latestCompleteAnalysis = null;

  @SerializedName("latestFailedAnalysis")
  private AnalysisRecord latestFailedAnalysis = null;

  @SerializedName("metadata")
  private List<MetadataValue> metadata = null;

  public ProjectQueryResponse id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ProjectQueryResponse name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "WebGoat", value = "")
  ...
  public ProjectQueryResponse parentId(Integer parentId) {
  ...
  **/
  ...
  public ProjectQueryResponse hierarchyIds(List<Integer> hierarchyIds) {
    this.hierarchyIds = hierarchyIds;
    return this;
  }

  public ProjectQueryResponse addHierarchyIdsItem(Integer hierarchyIdsItem) {
    if (this.hierarchyIds == null) {
      this.hierarchyIds = new ArrayList<Integer>();
    }
  ...
  **/
  ...
  public ProjectQueryResponse latestCompleteAnalysis(AnalysisRecord latestCompleteAnalysis) {
  ...
  **/
  @ApiModelProperty(value = "")
  public AnalysisRecord getLatestCompleteAnalysis() {
    return latestCompleteAnalysis;
  }

  public void setLatestCompleteAnalysis(AnalysisRecord latestCompleteAnalysis) {
    this.latestCompleteAnalysis = latestCompleteAnalysis;
  }

  public ProjectQueryResponse latestFailedAnalysis(AnalysisRecord latestFailedAnalysis) {
  ...
  **/
  @ApiModelProperty(value = "")
  public AnalysisRecord getLatestFailedAnalysis() {
    return latestFailedAnalysis;
  }

  public void setLatestFailedAnalysis(AnalysisRecord latestFailedAnalysis) {
    this.latestFailedAnalysis = latestFailedAnalysis;
  }

  public ProjectQueryResponse metadata(List<MetadataValue> metadata) {
    this.metadata = metadata;
    return this;
  }

  public ProjectQueryResponse addMetadataItem(MetadataValue metadataItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProjectQueryResponse projectQueryResponse = (ProjectQueryResponse) o;
    return Objects.equals(this.id, projectQueryResponse.id) &&
        Objects.equals(this.name, projectQueryResponse.name) &&
        Objects.equals(this.parentId, projectQueryResponse.parentId) &&
        Objects.equals(this.hierarchyIds, projectQueryResponse.hierarchyIds) &&
        Objects.equals(this.latestCompleteAnalysis, projectQueryResponse.latestCompleteAnalysis) &&
        Objects.equals(this.latestFailedAnalysis, projectQueryResponse.latestFailedAnalysis) &&
        Objects.equals(this.metadata, projectQueryResponse.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, parentId, hierarchyIds, latestCompleteAnalysis, latestFailedAnalysis, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectQueryResponse {\n");
