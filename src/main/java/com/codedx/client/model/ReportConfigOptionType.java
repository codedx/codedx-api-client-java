...
/**
 * A keyword describing what type of UI widget would be used to enter values for this field&amp;#58; - &#x60;dropdown&#x60;indicates a value should be chosen from the &#x60;options&#x60; field, specified by its &#x60;id&#x60; string - &#x60;checkbox&#x60; indicates a boolean value should be provided - &#x60;checkbox-list&#x60; indicates an array of &#x60;id&#x60; strings should be chosen from the options field - &#x60;text&#x60; indicates a plain text (string) value should be provided. May be validated by the &#x60;regex&#x60; field 
 */
@JsonAdapter(ReportConfigOptionType.Adapter.class)
public enum ReportConfigOptionType {
  ...
  ReportConfigOptionType(String value) {
    this.value = value;
  }
  ...
  public static ReportConfigOptionType fromValue(String text) {
    for (ReportConfigOptionType b : ReportConfigOptionType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReportConfigOptionType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReportConfigOptionType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReportConfigOptionType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReportConfigOptionType.fromValue(String.valueOf(value));
    }
  }
}
