...
public class Path {
  ...
  private Boolean hasSource = null;
  ...
  **/
  ...
  public Path shortName(String shortName) {
  ...
  **/
  ...
  public Path hasSource(Boolean hasSource) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, path.id) &&
        Objects.equals(this.pathType, path.pathType) &&
        Objects.equals(this.path, path.path) &&
        Objects.equals(this.shortName, path.shortName) &&
        Objects.equals(this.hasSource, path.hasSource);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, pathType, path, shortName, hasSource);
  }
  ...
  public String toString() {
    ...
    sb.append("    hasSource: ").append(toIndentedString(hasSource)).append("\n");
    sb.append("}");
    return sb.toString();
  }
