...
/**
 * The string form of the regular expression used to validate the field, and the message is an error message used by the UI if validation fails
 */
@ApiModel(description = "The string form of the regular expression used to validate the field, and the message is an error message used by the UI if validation fails")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-12-07T19:30:21.793Z")
public class ReportConfigRegex {
  ...
  public ReportConfigRegex regex(String regex) {
    this.regex = regex;
    return this;
  }
  ...
  **/
  ...
  public ReportConfigRegex message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ReportConfigRegex reportConfigRegex = (ReportConfigRegex) o;
    return Objects.equals(this.regex, reportConfigRegex.regex) &&
        Objects.equals(this.message, reportConfigRegex.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportConfigRegex {\n");
