...
public class InputDisplayInfo {
  @SerializedName("tags")
  private List<DisplayTagState> tags = null;
  ...
  public InputDisplayInfo tags(List<DisplayTagState> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public InputDisplayInfo addTagsItem(DisplayTagState tagsItem) {
    if (this.tags == null) {
      this.tags = new ArrayList<DisplayTagState>();
    }
  ...
  **/
  ...
  public void setTags(List<DisplayTagState> tags) {
    this.tags = tags;
  }

  public InputDisplayInfo scmInfo(ScmInfo scmInfo) {
  ...
  **/
  ...
  public InputDisplayInfo warnings(List<String> warnings) {
   ...
   * @return warnings
  **/
  @ApiModelProperty(value = "An array of strings that describe problems that may want to be addressed, but will not prevent analysis from starting")
  ...
  public InputDisplayInfo errors(List<String> errors) {
    this.errors = errors;
    return this;
  }
   ...
   * @return errors
  **/
  @ApiModelProperty(value = "An array of strings that describe problems that should be addressed before analysis can begin.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, scmInfo, warnings, errors);
  }
