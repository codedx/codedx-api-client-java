...
public class GenerateReport {
  ...
  **/
  ...
  public GenerateReport config(Map<String, Object> config) {
    this.config = config;
    return this;
  }

  public GenerateReport putConfigItem(String key, Object configItem) {
    if (this.config == null) {
   ...
   /**
   * This object will be a series of key value pairs. A key value field for each of the configOptions described by the Report Type, where the key is the configOption&#39;s id, and the value is the configuration value corresponding to that field’s type.
   * @return config
  **/
  @ApiModelProperty(value = "This object will be a series of key value pairs. A key value field for each of the configOptions described by the Report Type, where the key is the configOption's id, and the value is the configuration value corresponding to that field’s type.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GenerateReport generateReport = (GenerateReport) o;
    return Objects.equals(this.filter, generateReport.filter) &&
        Objects.equals(this.config, generateReport.config);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filter, config);
  }
