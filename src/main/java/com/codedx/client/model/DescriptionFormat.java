...
/**
 * Gets or Sets DescriptionFormat
 */
@JsonAdapter(DescriptionFormat.Adapter.class)
public enum DescriptionFormat {
  ...
  DescriptionFormat(String value) {
    this.value = value;
  }
  ...
  public static DescriptionFormat fromValue(String text) {
    for (DescriptionFormat b : DescriptionFormat.values()) {
  ...
  public static class Adapter extends TypeAdapter<DescriptionFormat> {
    @Override
    public void write(final JsonWriter jsonWriter, final DescriptionFormat enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DescriptionFormat read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DescriptionFormat.fromValue(String.valueOf(value));
    }
  }
}
