...
public class MetadataValue {
  ...
  public MetadataValue id(Integer id) {
    this.id = id;
    return this;
  }

   /**
   * Corresponds to the id of the field which is filled by this value
   * @return id
  **/
  @ApiModelProperty(value = "Corresponds to the id of the field which is filled by this value")
  ...
  public MetadataValue name(String name) {
    this.name = name;
    return this;
  }

   /**
   * Corresponds to the name of the field which is filled by this value
   * @return name
  **/
  @ApiModelProperty(value = "Corresponds to the name of the field which is filled by this value")
  ...
  public MetadataValue valueId(Integer valueId) {
    this.valueId = valueId;
    return this;
  }

   /**
   * corresponds to the valueId of the dropdown value chosen for this field. null if no value is chosen, or the field is not a dropdown
   * @return valueId
  **/
  @ApiModelProperty(value = "corresponds to the valueId of the dropdown value chosen for this field. null if no value is chosen, or the field is not a dropdown")
  ...
  public MetadataValue value(String value) {
   ...
   /**
   * The textual value of the field. If the field is a dropdown, this corresponds to the dropdown value&#39;s value field.
   * @return value
  **/
  @ApiModelProperty(value = "The textual value of the field. If the field is a dropdown, this corresponds to the dropdown value's value field.")
  ...
  public MetadataValue enumId(Integer enumId) {
    this.enumId = enumId;
    return this;
  }

   /**
   * (optional) corresponds to the selected dropdown value&#39;s id field
   * @return enumId
  **/
  @ApiModelProperty(value = "(optional) corresponds to the selected dropdown value's id field")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, metadataValue.id) &&
        Objects.equals(this.name, metadataValue.name) &&
        Objects.equals(this.valueId, metadataValue.valueId) &&
        Objects.equals(this.value, metadataValue.value) &&
        Objects.equals(this.enumId, metadataValue.enumId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, valueId, value, enumId);
  }
