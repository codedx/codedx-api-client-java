...
public class Metadata {
  ...
  /**
   * - &#x60;\&quot;text\&quot;&#x60; for fields where users may enter plain-text values - &#x60;\&quot;multiline-text\&quot;&#x60; for fields where users may enter long-form text, e.g. paragraphs - &#x60;\&quot;tags\&quot;&#x60; for fields where users may enter a collection of single-word items - &#x60;\&quot;enum\&quot;&#x60; for fields where users must select a choice from a dropdown menu 
   */
  ...
  private List<MetadataValue> values = null;
  ...
  public Metadata id(Integer id) {
   ...
   /**
   * A number which can be used to identify the field when using the API
   * @return id
  **/
  @ApiModelProperty(value = "A number which can be used to identify the field when using the API")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The user-facing name of the field")
  ...
  public Metadata type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(value = "- `\"text\"` for fields where users may enter plain-text values - `\"multiline-text\"` for fields where users may enter long-form text, e.g. paragraphs - `\"tags\"` for fields where users may enter a collection of single-word items - `\"enum\"` for fields where users must select a choice from a dropdown menu ")
  ...
  **/
  ...
  public Metadata values(List<MetadataValue> values) {
    this.values = values;
    return this;
  }

  public Metadata addValuesItem(MetadataValue valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<MetadataValue>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, metadata.id) &&
        ...
        Objects.equals(this.values, metadata.values);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, type, value, values);
  }
