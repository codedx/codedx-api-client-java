...
public class AnalysisQueryResponse {
  ...
  public AnalysisQueryResponse inputIds(List<String> inputIds) {
    this.inputIds = inputIds;
    return this;
  }

  public AnalysisQueryResponse addInputIdsItem(String inputIdsItem) {
   ...
   /**
   * An array of string identifiers of the inputs on this prep. Note that this will include the &#x60;inputId&#x60; of the SCM Input from the initial creation of the Analysis Prep, but will not include the additional scm-related information.
   * @return inputIds
  **/
  @ApiModelProperty(value = "An array of string identifiers of the inputs on this prep. Note that this will include the `inputId` of the SCM Input from the initial creation of the Analysis Prep, but will not include the additional scm-related information.")
  ...
  public AnalysisQueryResponse verificationErrors(List<String> verificationErrors) {
    this.verificationErrors = verificationErrors;
    return this;
  }

  public AnalysisQueryResponse addVerificationErrorsItem(String verificationErrorsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AnalysisQueryResponse analysisQueryResponse = (AnalysisQueryResponse) o;
    return Objects.equals(this.inputIds, analysisQueryResponse.inputIds) &&
        Objects.equals(this.verificationErrors, analysisQueryResponse.verificationErrors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inputIds, verificationErrors);
  }
