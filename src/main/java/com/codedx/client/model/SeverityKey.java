 ...
 */
@JsonAdapter(SeverityKey.Adapter.class)
public enum SeverityKey {
  ...
  public static SeverityKey fromValue(String text) {
    for (SeverityKey b : SeverityKey.values()) {
  ...
  public static class Adapter extends TypeAdapter<SeverityKey> {
    @Override
    public void write(final JsonWriter jsonWriter, final SeverityKey enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SeverityKey read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return SeverityKey.fromValue(String.valueOf(value));
    }
  }
}
