...
/**
 * An optional object which, if present, describes the automatically-created \&quot;SCM Input\&quot; to the analyses, e.g. source pulled from Git.
 */
...
public class ScmSetup {
  ...
  **/
  ...
  public ScmSetup inputId(String inputId) {
    this.inputId = inputId;
    return this;
  }

   /**
   * the ID for the \&quot;SCM Input\&quot;, which should be used when constructing URLs for interacting with this input.
   * @return inputId
  **/
  ...
  public ScmSetup setupJobId(String setupJobId) {
    this.setupJobId = setupJobId;
    return this;
  }

   /**
   * a job ID. The setup process for an SCM Input can take some time, so the setup job should be monitored via the Job System. Once the job is complete, the content of the repository will be ready to analyze.
   * @return setupJobId
  **/
  ...
  public void setSetupJobId(String setupJobId) {
    this.setupJobId = setupJobId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ScmSetup scmSetup = (ScmSetup) o;
    return Objects.equals(this.scmInfo, scmSetup.scmInfo) &&
        Objects.equals(this.inputId, scmSetup.inputId) &&
        Objects.equals(this.setupJobId, scmSetup.setupJobId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scmInfo, inputId, setupJobId);
  }
  ...
  public String toString() {
    ...
    sb.append("    setupJobId: ").append(toIndentedString(setupJobId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
