...
public class RuleSetContents {
  ...
  public RuleSetContents id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public RuleSetContents name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RuleSetContents rules(List<Rule> rules) {
    this.rules = rules;
    return this;
  }

  public RuleSetContents addRulesItem(Rule rulesItem) {
    if (this.rules == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RuleSetContents ruleSetContents = (RuleSetContents) o;
    return Objects.equals(this.id, ruleSetContents.id) &&
        Objects.equals(this.name, ruleSetContents.name) &&
        Objects.equals(this.rules, ruleSetContents.rules);
  }
  ...
  public String toString() {
    ...
    sb.append("class RuleSetContents {\n");
