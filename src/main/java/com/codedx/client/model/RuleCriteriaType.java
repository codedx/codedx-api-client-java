...
/**
 * Gets or Sets RuleCriteriaType
 */
@JsonAdapter(RuleCriteriaType.Adapter.class)
public enum RuleCriteriaType {
  ...
  public static RuleCriteriaType fromValue(String text) {
    for (RuleCriteriaType b : RuleCriteriaType.values()) {
  ...
  public static class Adapter extends TypeAdapter<RuleCriteriaType> {
    @Override
    public void write(final JsonWriter jsonWriter, final RuleCriteriaType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public RuleCriteriaType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return RuleCriteriaType.fromValue(String.valueOf(value));
    }
  }
}
