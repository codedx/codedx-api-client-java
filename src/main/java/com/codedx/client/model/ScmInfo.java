...
import com.codedx.client.model.Rev;
...
/**
 * An Object describing how the content will be generated
 */
...
public class ScmInfo {
  ...
  public ScmInfo repoType(String repoType) {
    this.repoType = repoType;
    return this;
  }

   /**
   * In current versions of Code Dx, this will only ever be the string \&quot;git\&quot;
   * @return repoType
  **/
  @ApiModelProperty(value = "In current versions of Code Dx, this will only ever be the string \"git\"")
  ...
  public ScmInfo url(String url) {
    this.url = url;
    return this;
  }

   /**
   * The URL of the repository to pull source from
   * @return url
  **/
  @ApiModelProperty(value = "The URL of the repository to pull source from")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.repoType, scmInfo.repoType) &&
        Objects.equals(this.url, scmInfo.url) &&
        Objects.equals(this.rev, scmInfo.rev);
  }

  @Override
  public int hashCode() {
    return Objects.hash(repoType, url, rev);
  }
