...
public class MappingsRequest {
  ...
  public MappingsRequest files(List<String> files) {
    this.files = files;
    return this;
  }

  public MappingsRequest addFilesItem(String filesItem) {
    if (this.files == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MappingsRequest mappingsRequest = (MappingsRequest) o;
    return Objects.equals(this.files, mappingsRequest.files);
  }
  ...
  public String toString() {
    ...
    sb.append("class MappingsRequest {\n");
