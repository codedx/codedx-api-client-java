...
/**
 * An object specifiying the version being pulled from the repository
 */
...
public class Rev {
   ...
   */
  @JsonAdapter(RevTypeEnum.Adapter.class)
  public enum RevTypeEnum {
    ...
    public static RevTypeEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<RevTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final RevTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public RevTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return RevTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  public Rev revType(RevTypeEnum revType) {
  ...
  **/
  ...
  public Rev revName(String revName) {
    this.revName = revName;
    return this;
  }

   /**
   * The name of the branch or tag, or the commit hash/id
   * @return revName
  **/
  @ApiModelProperty(value = "The name of the branch or tag, or the commit hash/id")
  ...
  public Rev revDetail(String revDetail) {
    this.revDetail = revDetail;
    return this;
  }

   /**
   * Optional detail about branches and tags, typically the associated commit hash/id
   * @return revDetail
  **/
  @ApiModelProperty(value = "Optional detail about branches and tags, typically the associated commit hash/id")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.revType, rev.revType) &&
        Objects.equals(this.revName, rev.revName) &&
        Objects.equals(this.revDetail, rev.revDetail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(revType, revName, revDetail);
  }
  ...
  public String toString() {
    ...
    sb.append("    revName: ").append(toIndentedString(revName)).append("\n");
    sb.append("    revDetail: ").append(toIndentedString(revDetail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
