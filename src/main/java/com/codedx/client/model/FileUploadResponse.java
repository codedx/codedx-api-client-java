...
public class FileUploadResponse {
  ...
  public FileUploadResponse jobId(String jobId) {
   ...
   /**
   * the ID of the content identification task. The task may be monitored via the Job System.
   * @return jobId
  **/
  @ApiModelProperty(value = "the ID of the content identification task. The task may be monitored via the Job System.")
  ...
  public FileUploadResponse inputId(String inputId) {
    this.inputId = inputId;
    return this;
  }

   /**
   * the ID of the input created by uploading the file. This ID should be used when constructing URLs for interacting with the input.
   * @return inputId
  **/
  @ApiModelProperty(value = "the ID of the input created by uploading the file. This ID should be used when constructing URLs for interacting with the input.")
  ...
  public FileUploadResponse size(Integer size) {
    this.size = size;
    return this;
  }

   /**
   * The size (in bytes) of the uploaded file. Note that this may differ from the original size of the file, as Code Dx performs some internal cleanup of zip-like files.
   * @return size
  **/
  @ApiModelProperty(value = "The size (in bytes) of the uploaded file. Note that this may differ from the original size of the file, as Code Dx performs some internal cleanup of zip-like files.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.jobId, fileUploadResponse.jobId) &&
        Objects.equals(this.inputId, fileUploadResponse.inputId) &&
        Objects.equals(this.size, fileUploadResponse.size);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, inputId, size);
  }
