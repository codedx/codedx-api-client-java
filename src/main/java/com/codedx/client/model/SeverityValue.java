 ...
 */
@JsonAdapter(SeverityValue.Adapter.class)
public enum SeverityValue {
  ...
  public static class Adapter extends TypeAdapter<SeverityValue> {
    @Override
    public void write(final JsonWriter jsonWriter, final SeverityValue enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SeverityValue read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SeverityValue.fromValue(String.valueOf(value));
    }
  }
}
