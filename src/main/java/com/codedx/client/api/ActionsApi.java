...
public class ActionsApi {
     ...
     */
    public com.squareup.okhttp.Call clearSeverityOverrideCall(Integer findingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call clearSeverityOverrideValidateBeforeCall(Integer findingId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'findingId' is set
        if (findingId == null) {
            throw new ApiException("Missing the required parameter 'findingId' when calling clearSeverityOverride(Async)");
        }
        

        com.squareup.okhttp.Call call = clearSeverityOverrideCall(findingId, progressListener, progressRequestListener);
        return call;
    ...
    public void clearSeverityOverride(Integer findingId) throws ApiException {
        clearSeverityOverrideWithHttpInfo(findingId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> clearSeverityOverrideWithHttpInfo(Integer findingId) throws ApiException {
        com.squareup.okhttp.Call call = clearSeverityOverrideValidateBeforeCall(findingId, null, null);
     ...
     */
    public com.squareup.okhttp.Call clearSeverityOverrideAsync(Integer findingId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = clearSeverityOverrideValidateBeforeCall(findingId, progressListener, progressRequestListener);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call overrideSeverityCall(Integer findingId, SeverityOverride severity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call overrideSeverityValidateBeforeCall(Integer findingId, SeverityOverride severity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'findingId' is set
        if (findingId == null) {
            throw new ApiException("Missing the required parameter 'findingId' when calling overrideSeverity(Async)");
        }
        

        com.squareup.okhttp.Call call = overrideSeverityCall(findingId, severity, progressListener, progressRequestListener);
        return call;
    ...
    public void overrideSeverity(Integer findingId, SeverityOverride severity) throws ApiException {
        overrideSeverityWithHttpInfo(findingId, severity);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> overrideSeverityWithHttpInfo(Integer findingId, SeverityOverride severity) throws ApiException {
        com.squareup.okhttp.Call call = overrideSeverityValidateBeforeCall(findingId, severity, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call overrideSeverityAsync(Integer findingId, SeverityOverride severity, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = overrideSeverityValidateBeforeCall(findingId, severity, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postCommentCall(Integer findingId, PostComment content, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postCommentValidateBeforeCall(Integer findingId, PostComment content, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'findingId' is set
        if (findingId == null) {
            throw new ApiException("Missing the required parameter 'findingId' when calling postComment(Async)");
        }
        
        // verify the required parameter 'content' is set
        if (content == null) {
            throw new ApiException("Missing the required parameter 'content' when calling postComment(Async)");
        }
        

        com.squareup.okhttp.Call call = postCommentCall(findingId, content, progressListener, progressRequestListener);
        return call;
    ...
    public void postComment(Integer findingId, PostComment content) throws ApiException {
        postCommentWithHttpInfo(findingId, content);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postCommentWithHttpInfo(Integer findingId, PostComment content) throws ApiException {
        com.squareup.okhttp.Call call = postCommentValidateBeforeCall(findingId, content, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postCommentAsync(Integer findingId, PostComment content, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postCommentValidateBeforeCall(findingId, content, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setBulkStatusCall(Integer projectId, SetStatusBulk bulkStatusUpdate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setBulkStatusValidateBeforeCall(Integer projectId, SetStatusBulk bulkStatusUpdate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling setBulkStatus(Async)");
        }
        

        com.squareup.okhttp.Call call = setBulkStatusCall(projectId, bulkStatusUpdate, progressListener, progressRequestListener);
        return call;
    ...
    public Job setBulkStatus(Integer projectId, SetStatusBulk bulkStatusUpdate) throws ApiException {
        ApiResponse<Job> resp = setBulkStatusWithHttpInfo(projectId, bulkStatusUpdate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Job> setBulkStatusWithHttpInfo(Integer projectId, SetStatusBulk bulkStatusUpdate) throws ApiException {
        com.squareup.okhttp.Call call = setBulkStatusValidateBeforeCall(projectId, bulkStatusUpdate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setBulkStatusAsync(Integer projectId, SetStatusBulk bulkStatusUpdate, final ApiCallback<Job> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setBulkStatusValidateBeforeCall(projectId, bulkStatusUpdate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setStatusCall(Integer findingId, SetStatus status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setStatusValidateBeforeCall(Integer findingId, SetStatus status, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'findingId' is set
        if (findingId == null) {
            throw new ApiException("Missing the required parameter 'findingId' when calling setStatus(Async)");
        }
        
        // verify the required parameter 'status' is set
        if (status == null) {
            throw new ApiException("Missing the required parameter 'status' when calling setStatus(Async)");
        }
        

        com.squareup.okhttp.Call call = setStatusCall(findingId, status, progressListener, progressRequestListener);
        return call;
    ...
    public void setStatus(Integer findingId, SetStatus status) throws ApiException {
        setStatusWithHttpInfo(findingId, status);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> setStatusWithHttpInfo(Integer findingId, SetStatus status) throws ApiException {
        com.squareup.okhttp.Call call = setStatusValidateBeforeCall(findingId, status, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setStatusAsync(Integer findingId, SetStatus status, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setStatusValidateBeforeCall(findingId, status, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
