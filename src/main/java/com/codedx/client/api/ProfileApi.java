...
public class ProfileApi {
     ...
     */
    public com.squareup.okhttp.Call profileChangePasswordCall(ProfilePasswordChange passwordChangeBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call profileChangePasswordValidateBeforeCall(ProfilePasswordChange passwordChangeBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = profileChangePasswordCall(passwordChangeBody, progressListener, progressRequestListener);
        return call;
    ...
    public void profileChangePassword(ProfilePasswordChange passwordChangeBody) throws ApiException {
        profileChangePasswordWithHttpInfo(passwordChangeBody);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> profileChangePasswordWithHttpInfo(ProfilePasswordChange passwordChangeBody) throws ApiException {
        com.squareup.okhttp.Call call = profileChangePasswordValidateBeforeCall(passwordChangeBody, null, null);
     ...
     */
    public com.squareup.okhttp.Call profileChangePasswordAsync(ProfilePasswordChange passwordChangeBody, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = profileChangePasswordValidateBeforeCall(passwordChangeBody, progressListener, progressRequestListener);
