...
public class JobsApi {
     ...
     * @param jobId The ID of the job to get the result for (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getJobResultCall(String jobId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getJobResultValidateBeforeCall(String jobId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling getJobResult(Async)");
        }
        

        com.squareup.okhttp.Call call = getJobResultCall(jobId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public File getJobResult(String jobId) throws ApiException {
        ApiResponse<File> resp = getJobResultWithHttpInfo(jobId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<File> getJobResultWithHttpInfo(String jobId) throws ApiException {
        com.squareup.okhttp.Call call = getJobResultValidateBeforeCall(jobId, null, null);
     ...
     */
    public com.squareup.okhttp.Call getJobResultAsync(String jobId, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getJobResultValidateBeforeCall(jobId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
