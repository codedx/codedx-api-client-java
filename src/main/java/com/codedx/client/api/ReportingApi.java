...
public class ReportingApi {
     ...
     */
    public com.squareup.okhttp.Call generateReportCall(Integer projectId, String reportType, GenerateReport body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call generateReportValidateBeforeCall(Integer projectId, String reportType, GenerateReport body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = generateReportCall(projectId, reportType, body, progressListener, progressRequestListener);
        return call;
    ...
    public Job generateReport(Integer projectId, String reportType, GenerateReport body) throws ApiException {
        ApiResponse<Job> resp = generateReportWithHttpInfo(projectId, reportType, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Job> generateReportWithHttpInfo(Integer projectId, String reportType, GenerateReport body) throws ApiException {
        com.squareup.okhttp.Call call = generateReportValidateBeforeCall(projectId, reportType, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call generateReportAsync(Integer projectId, String reportType, GenerateReport body, final ApiCallback<Job> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = generateReportValidateBeforeCall(projectId, reportType, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getReportTypesCall(Integer projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReportTypesValidateBeforeCall(Integer projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getReportTypesCall(projectId, progressListener, progressRequestListener);
        return call;
    ...
    public Map<String, ReportType> getReportTypes(Integer projectId) throws ApiException {
        ApiResponse<Map<String, ReportType>> resp = getReportTypesWithHttpInfo(projectId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Map<String, ReportType>> getReportTypesWithHttpInfo(Integer projectId) throws ApiException {
        com.squareup.okhttp.Call call = getReportTypesValidateBeforeCall(projectId, null, null);
        Type localVarReturnType = new TypeToken<Map<String, ReportType>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getReportTypesAsync(Integer projectId, final ApiCallback<Map<String, ReportType>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getReportTypesValidateBeforeCall(projectId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Map<String, ReportType>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
