...
public class FindingDataMaintenanceApi {
     ...
     */
    public com.squareup.okhttp.Call getDisabledToolResultCountCall(Integer projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getDisabledToolResultCountValidateBeforeCall(Integer projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling getDisabledToolResultCount(Async)");
        }
        

        com.squareup.okhttp.Call call = getDisabledToolResultCountCall(projectId, progressListener, progressRequestListener);
        return call;
    ...
    public DisabledToolResultsCount getDisabledToolResultCount(Integer projectId) throws ApiException {
        ApiResponse<DisabledToolResultsCount> resp = getDisabledToolResultCountWithHttpInfo(projectId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DisabledToolResultsCount> getDisabledToolResultCountWithHttpInfo(Integer projectId) throws ApiException {
        com.squareup.okhttp.Call call = getDisabledToolResultCountValidateBeforeCall(projectId, null, null);
        Type localVarReturnType = new TypeToken<DisabledToolResultsCount>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getDisabledToolResultCountAsync(Integer projectId, final ApiCallback<DisabledToolResultsCount> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDisabledToolResultCountValidateBeforeCall(projectId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DisabledToolResultsCount>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call purgeDisabledToolResultsCall(Integer projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call purgeDisabledToolResultsValidateBeforeCall(Integer projectId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling purgeDisabledToolResults(Async)");
        }
        

        com.squareup.okhttp.Call call = purgeDisabledToolResultsCall(projectId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> purgeDisabledToolResultsWithHttpInfo(Integer projectId) throws ApiException {
        com.squareup.okhttp.Call call = purgeDisabledToolResultsValidateBeforeCall(projectId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call purgeDisabledToolResultsAsync(Integer projectId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = purgeDisabledToolResultsValidateBeforeCall(projectId, progressListener, progressRequestListener);
