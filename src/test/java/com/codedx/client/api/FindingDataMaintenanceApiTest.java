...
/**
 * API tests for FindingDataMaintenanceApi
 */
@Ignore
public class FindingDataMaintenanceApiTest {

    private final FindingDataMaintenanceApi api = new FindingDataMaintenanceApi();
     ...
     */
    @Test
    public void getDisabledToolResultCountTest() throws ApiException {
        Integer projectId = null;
        DisabledToolResultsCount response = api.getDisabledToolResultCount(projectId);
     ...
     */
    @Test
    public void purgeDisabledToolResultsTest() throws ApiException {
        Integer projectId = null;
        api.purgeDisabledToolResults(projectId);
