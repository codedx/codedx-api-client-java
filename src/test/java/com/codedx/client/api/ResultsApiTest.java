...
public class ResultsApiTest {
     ...
     */
    @Test
    public void createDetectionMethodTest() throws ApiException {
        DetectionMethod detectionMethod = null;
        DetectionMethod response = api.createDetectionMethod(detectionMethod);
     ...
     */
    @Test
    public void createManualResultTest() throws ApiException {
        ManualResultRequest manualResultRequest = null;
        ManualResultResponse response = api.createManualResult(manualResultRequest);
     ...
     */
    @Test
    public void deleteDetectionMethodTest() throws ApiException {
        Integer detectionMethodId = null;
        Integer replacement = null;
        api.deleteDetectionMethod(detectionMethodId, replacement);
     ...
     */
    @Test
    public void deleteManualResultTest() throws ApiException {
        Integer resultId = null;
        api.deleteManualResult(resultId);
     ...
     */
    @Test
    public void getAllDetectionMethodsTest() throws ApiException {
        List<DetectionMethod> response = api.getAllDetectionMethods();
     ...
     */
    @Test
    public void getManualResultAllowedToolsTest() throws ApiException {
        List<String> response = api.getManualResultAllowedTools();
     ...
     */
    @Test
    public void modifyManualResultAllowedToolTest() throws ApiException {
        String tool = null;
        Boolean allowed = null;
        api.modifyManualResultAllowedTool(tool, allowed);
     ...
     */
    @Test
    public void renameDetectionMethodTest() throws ApiException {
        Integer detectionMethodId = null;
        DetectionMethod detectionMethod = null;
        DetectionMethod response = api.renameDetectionMethod(detectionMethodId, detectionMethod);
     ...
     */
    @Test
    public void replaceManualResultTest() throws ApiException {
        Integer resultId = null;
        ManualResultRequest manualResultRequest = null;
        ManualResultResponse response = api.replaceManualResult(resultId, manualResultRequest);
