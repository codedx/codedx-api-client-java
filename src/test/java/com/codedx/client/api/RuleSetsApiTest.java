...
public class RuleSetsApiTest {
     ...
     */
    @Test
    public void addRuleCriteriaTest() throws ApiException {
        Integer rulesetId = null;
        Integer ruleId = null;
        RuleCriteria ruleCriteria = null;
        api.addRuleCriteria(rulesetId, ruleId, ruleCriteria);
     ...
     */
    @Test
    public void cloneRuleSetTest() throws ApiException {
        Integer rulesetId = null;
        RuleSet ruleSet = null;
        RuleSet response = api.cloneRuleSet(rulesetId, ruleSet);
    ...
    public void createRuleTest() throws ApiException {
        ...
        Rule response = api.createRule(rulesetId, rule);
    ...
    public void createRuleSetTest() throws ApiException {
        RuleSet ruleSet = null;
        RuleSet response = api.createRuleSet(ruleSet);
    ...
    public void deleteRuleTest() throws ApiException {
        Integer rulesetId = null;
        Integer ruleId = null;
        api.deleteRule(rulesetId, ruleId);
     ...
     */
    @Test
    public void deleteRuleCriteriaTest() throws ApiException {
        Integer rulesetId = null;
        Integer ruleId = null;
        RuleCriteria ruleCriteria = null;
        api.deleteRuleCriteria(rulesetId, ruleId, ruleCriteria);
    ...
    public void deleteRuleSetTest() throws ApiException {
        Integer rulesetId = null;
        Boolean force = null;
        RuleSetDeleteResponse response = api.deleteRuleSet(rulesetId, force);
     ...
     */
    @Test
    public void exportRuleSetTest() throws ApiException {
        Integer rulesetId = null;
        File response = api.exportRuleSet(rulesetId);
     ...
     */
    @Test
    public void getAllRuleSetsTest() throws ApiException {
        List<RuleSet> response = api.getAllRuleSets();
     ...
     */
    @Test
    public void getRuleDataTest() throws ApiException {
        Integer rulesetId = null;
        Integer ruleId = null;
        Rule response = api.getRuleData(rulesetId, ruleId);
     ...
     */
    @Test
    public void getRuleSetContentsTest() throws ApiException {
        Integer rulesetId = null;
        RuleSetContents response = api.getRuleSetContents(rulesetId);
     ...
     */
    @Test
    public void modifyRuleDataTest() throws ApiException {
        Integer rulesetId = null;
        Integer ruleId = null;
        CreateRule rule = null;
        ModifyRuleResponse response = api.modifyRuleData(rulesetId, ruleId, rule);
     ...
     */
    @Test
    public void renameRuleSetTest() throws ApiException {
        Integer rulesetId = null;
        RuleSet ruleSet = null;
        RuleSet response = api.renameRuleSet(rulesetId, ruleSet);
    ...
    public void updateRuleSetTest() throws ApiException {
        File ruleSetXml = null;
        Integer rulesetId = null;
        RuleSet response = api.updateRuleSet(ruleSetXml, rulesetId);
     ...
     */
    @Test
    public void uploadRuleSetTest() throws ApiException {
        File ruleSetXml = null;
        RuleSet response = api.uploadRuleSet(ruleSetXml);
