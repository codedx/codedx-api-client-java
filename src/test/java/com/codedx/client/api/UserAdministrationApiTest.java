...
/**
 * API tests for UserAdministrationApi
 */
@Ignore
public class UserAdministrationApiTest {

    private final UserAdministrationApi api = new UserAdministrationApi();
    ...
    public void changeUserPasswordTest() throws ApiException {
        ...
        api.changeUserPassword(userId, password);
     ...
     */
    @Test
    public void createExternalUserTest() throws ApiException {
        CreateUser user = null;
        User response = api.createExternalUser(user);
     ...
     */
    @Test
    public void createKeyUserTest() throws ApiException {
        CreateUser user = null;
        User response = api.createKeyUser(user);
     ...
     */
    @Test
    public void createLdapUserTest() throws ApiException {
        CreateUser user = null;
        User response = api.createLdapUser(user);
    ...
    public void createLocalUserTest() throws ApiException {
        CreateUser user = null;
        User response = api.createLocalUser(user);
    ...
    public void getExternalUsersTest() throws ApiException {
        List<User> response = api.getExternalUsers();
     ...
     */
    @Test
    public void getKeyUsersTest() throws ApiException {
        List<User> response = api.getKeyUsers();
     ...
     */
    @Test
    public void getLdapUsersTest() throws ApiException {
        List<User> response = api.getLdapUsers();
     ...
     */
    @Test
    public void getLocalUsersTest() throws ApiException {
        List<User> response = api.getLocalUsers();
    ...
    public void modifyUserTest() throws ApiException {
        ...
        User response = api.modifyUser(userId, disableUser);
    ...
    public void regenerateApiKeyTest() throws ApiException {
        Integer userId = null;
        User response = api.regenerateApiKey(userId);
